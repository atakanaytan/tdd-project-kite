...
describe('LoginPage', () => {
    ...
    describe('Interactions', () => {
        ...
        it('postLogin with credentials in body', () => {
            const actions = {
                postLogin: jest.fn().mockResolvedValue({})
            };
            setupForSubmit({ actions });
        ...
        it('does not allow user to click the Login button when the is an ongoing api call', () => {
            const actions = {
