...
describe('App', () => {
    ...
    it('displays UsersSignupPage when url is /signup', () => {
  ...
  it('saves logged in user data to localStorage after login success', async () => {
    ...
    const dataInStorage = JSON.parse(localStorage.getItem('kite-auth'));
  ...
  it('sets axios authorization with base64 encoded user credentials after login success', async () => {
    ...
    it('updates user page after clicking my profile when another nonexisting user page was opened', async () => {
      apiCalls.getUser = jest
        .fn()
